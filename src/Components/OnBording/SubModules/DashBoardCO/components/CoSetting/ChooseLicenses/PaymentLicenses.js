        ...
        license: values.license.map((licenseValue) => {
          return {
            ...
            selected:
              fields &&
              fields.length > 0 &&
              fields.selectedLiecenseIdArray.includes(licenseValue.name)
                ? true
                : false,
            sublicense: licenseValue.sublicense.map((subValue) => {
              return {
                ...
                selected:
                  fields &&
                  fields.length > 0 &&
                  fields.selectedLiecenseIdArray.includes(subValue.name)
                    ? true
                    : false,
              };
            }),
      ...
      <div>
        ...
        <div className="mt-2">
          ...
          <div className="d-flex justify-content-center">
            <button className="upgrade-button ">Purhcase License</button>
          </div>
        </div>
      </div>
    </>
