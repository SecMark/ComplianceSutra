              ...
              <>
                  ...
                  {displayTask === "1" && isMobile && (
                    <div className="take-action mb-0 d-none d-md-block">
                      <ul className="pull-right" style={{ float: "right" }}>
                        ...
                        <span
                          className={taskListDisplay === "1" && "active"}
                          style={{
                            fontSize: "10px",
                            marginLeft: "10px",
                            paddingLeft: "6px",
                        ...
                        <span
                          className={taskListDisplay === "2" && "active"}
                          style={{
                            fontSize: "11px",
                            marginLeft: "10px",
                            paddingLeft: "6px",
                        ...
                        <span
                          className={taskListDisplay === "3" && "active"}
                          style={{
                            fontSize: "11px",
                            marginLeft: "10px",
                            paddingLeft: "6px",
                        ...
                        <span
                          className={taskListDisplay === "4" && "active"}
                          style={{
                            fontSize: "11px",
                            marginLeft: "10px",
                            paddingLeft: "6px",
                ...
                {displayTask === "2" && searchValue === "" && (
                  <div>
                    ...
                    >
                      {isMobile && taskData && taskData.length > 0 && (
                        <div className="task-list-grid">
                          <BoardView
