          ...
          <div className="task-details-file-grid task-details-file-grid-dashboard custimDesignTask" style={{position: "relative"}}>
            ...
            {searchValue === "" && (
              <span>
                  ...
                  {displayTask === "1" &&  isMobile &&
                    <div className="take-action mb-0 d-none d-sm-block">
                      <ul className="pull-right" style={{ float: "right" }}>
                        ...
                        <span className={taskListDisplay === "1" && "active"} style={{ fontSize: "10px", marginLeft: "10px", paddingLeft: "6px", paddingRight: "6px", cursor: "pointer" }} onClick={e => {
                          if (displayTask === "1") {
                        ...
                        <span className={taskListDisplay === "2" && "active"} style={{ fontSize: "11px", marginLeft: "10px", paddingLeft: "6px", paddingRight: "6px", cursor: "pointer" }} onClick={e => {
                          if (displayTask === "1") {
                        ...
                        <span className={taskListDisplay === "3" && "active"} style={{ fontSize: "11px", marginLeft: "10px", paddingLeft: "6px", paddingRight: "6px", cursor: "pointer" }} onClick={e => {
                          if (displayTask === "1") {
                        ...
                        <span className={taskListDisplay === "4" && "active"} style={{ fontSize: "11px", marginLeft: "10px", paddingLeft: "6px", paddingRight: "6px", cursor: "pointer" }} onClick={e => {
                          if (displayTask === "1") {
                ...
                { isMobile &&  displayTask === "2" && searchValue === "" &&
            <div className="take-action">
                ...
                { displayTask === "2" && searchValue === "" &&
                  <div>
                    ...
                    <div className={displayTask === "1" && "task-grid-scroll-new customScrollSecond noXscroll maxHeihgtAuto"}
                        onScroll={()=>{
