    ...
    return (
        <div>
            <div className="task-list-grid">
                <div className="">
                  { licensetaskData && props.sideBarTaskList === false && 
              ...
              {
              licensetaskData && props.sideBarTaskList === true &&
              licensetaskData.length > 0 &&
              licensetaskData.map((item, index) => {
                return (
                <>
                { item.Status !== "Assign" &&
                  <div className="all-companies-task-grid-2 inside-padding-sidebar">
                      <div className="">
                      <div className="task-list-grid">
                      <div className="upcoming-btn mb-3" style={{ cursor: "pointer",padding:"0px 7px 0px" }} >
                        {item.Status} </div>
                        {
                        item.Status.trim() === "overdue" &&
                          item.Details.slice(
                            ...
                            return (
                              <>{renderSidebarTaskList(task, item.Status.trim(), 1)}</>
                            )
                          })}
                        {item.Status.trim() != "overdue" &&
