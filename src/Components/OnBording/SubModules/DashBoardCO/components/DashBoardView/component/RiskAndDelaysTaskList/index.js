                ...
                riskData.map((item) => {
                    ...
                    item.EntityDetails.forEach((task) => {
                        task.Licdetails.forEach((task1) => {
                            let data = task1
                            let newObjData =  Object.assign(data,{licCode: task.liccode,EntityCode : EntityName})
                        ...
                        <div className="task-list-grid">
                            ...
                            <div className="pink-circle-closing">
                                <div className="pink-label-close">Risk & Delays </div>
                                    <img style={{ cursor: "pointer" }} onClick={() => setClick("")} className="pink-label-close-icon" src={delayCloseIcon} alt="" />
                            </div>
                            </div>
                            {
                                riskOrDelayArr && riskOrDelayArr.length > 0 && riskOrDelayArr.map((task)=>{
                                return<>
                                    <Link
                                        to="/dashboard"
                                ...
                                <div className="row mb-16">
                                    <div className="col-10 col-md-5 col-sm-5 col-xl-5">
                                        <div className="all-companies-sub-title new-task-list">
                                            <div className="pending-list-mobile">
                                                <div className="graybox-left"><span className="all-companies-nse-label">{task.licCode && task.licCode}</span></div>
                                                <span className="pink-label-title-right">
                                                    <div className="overdue-title">{task.TaskName && task.TaskName}</div>
                                                    <div className="black-week d-block d-sm-none"><div className="d-block d-sm-none">Today</div></div>
                                    ...
                                    <div className="col-2 col-md-2 col-sm-2 col-xl-2 d-none d-sm-block"><div className="circle-front-text" value="717149">{task.EntityCode}</div></div>
                                    <div className="col-2 col-md-3 col-sm-3 col-xl-3 d-none d-sm-block" >
                                       {task && task.AssignedTo &&   <div className="d-flex new-task-list">
                                            <div className="circle-name d-none d-sm-block"><div className="circle-text">
                                                {
                                                 getInitials(
                                                    task &&
                                                    task.AssignedTo
                                            ...
                                            <div className="circle-front-text d-none d-sm-block mail">{task.AssignedTo}</div>
                                        </div>}
                                    </div>
                                    <div className="col-2">
