...
function DashBoardView({ history }) {
    ...
    return (
       ...
       <div className="mobile-head d-block d-sm-none">
        ...
        <div className="row co-dashboard remove-scroll-b" style={{height:"auto"}}>
            ...
            <div>
                {
                    isMobile ? 
                        listView === "0" && click ==="" &&
                        <QuickOverViewSection click={click} setClick={setClick} setListView={setListView} listView={listView} />
                    :
                    <QuickOverViewSection click={click} setClick={setClick} setListView={setListView} listView={listView} />
                }
            </div>
