...
const GET_TASK_COMMENTS_SUCCESS_BY_TASK_ID = "CAPMTECH/GET_TASK_COMMENTS_SUCCESS_BY_TASK_ID";
const GET_TASK_COMMENTS_FAILED_BY_TASK_ID = "CAPMTECH/GET_TASK_COMMENTS_FAILED_BY_TASK_ID";
...
const POST_UPLOAD_FILE_SUCCESS_BY_TASK_ID = "CAPMTECH/POST_TASK_COMMENT_SUCCESS_BY_TASK_ID";
const POST_UPLOAD_FILE_FAILED_BY_TASK_ID = "CAPMTECH/POST_TASK_COMMENTS_FAILED_BY_TASK_ID";

const POST_ASSIGN_TASK_BY_TASKID = "CAPMTECH/POST_ASSIGN_TASK_BY_TASKID";
const POST_ASSIGN_TASK_SUCCESS_BY_TASKID = "CAPMTECH/POST_ASSIGN_TASK_SUCCESS_BY_TASKID";
const POST_ASSIGN_TASK_FAILED_BY_TASKID = "CAPMTECH/POST_ASSIGN_TASK_FAILED_BY_TASKID";

const GET_AVAILABILITY_CHECK = "CAPMTECH/GET_AVAILABILITY_CHECK";
const GET_AVAILABILITY_CHECK_SUCCESS = "CAPMTECH/GET_AVAILABILITY_CHECK_SUCCESS";
const GET_AVAILABILITY_CHECK_FAILED = "CAPMTECH/GET_AVAILABILITY_CHECK_FAILED"

const CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST = "CAPMTECH/CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST";
const CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_SUCCESS = "CAPMTECH/CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_SUCCESS";
const CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_FAILED = "CAPMTECH/CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_FAILED"
...
const GET_ENTITY_LICENSE_TASK_REQUEST_SUCCESS = "GET_ENTITY_LICENSE_TASK_REQUEST_SUCCESS";
const GET_ENTITY_LICENSE_TASK_REQUEST_FAILED = "GET_ENTITY_LICENSE_TASK_REQUEST_FAILED";
...
const INS_CERTIFICATE_DETAILS_REQUEST_SUCCESS = "INS_CERTIFICATE_DETAILS_REQUEST_SUCCESS";
const INS_CERTIFICATE_DETAILS_REQUEST_FAILED = "INS_CERTIFICATE_DETAILS_REQUEST_FAILED";

const GET_CO_NOTIFICATIONS_REQUEST = "GET_CO_NOTIFICATIONS_REQUEST";
const GET_CO_NOTIFICATIONS_REQUEST_SUCCESS = "GET_CO_NOTIFICATIONS_REQUEST_SUCCESS";
const GET_CO_NOTIFICATIONS_REQUEST_FAILED = "GET_CO_NOTIFICATIONS_REQUEST_FAILED";
...
const GET_CO_ACCOUNT_LICENSES_REQUEST_SUCCESS = "GET_CO_ACCOUNT_LICENSES_REQUEST_SUCCESS";
const GET_CO_ACCOUNT_LICENSES_REQUEST_FAILED = "GET_CO_ACCOUNT_LICENSES_REQUEST_FAILED";
...
const taskReportByIdRequestSuccess = createAction(GET_TASK_REPORT_SUCCESS_BY_ID);
...
const taskCommentsByTaskIdSuccess = createAction(GET_TASK_COMMENTS_SUCCESS_BY_TASK_ID);
const taskCommentsByTaskIdFailed = createAction(GET_TASK_COMMENTS_FAILED_BY_TASK_ID);
...
const postUploadFileByIDSuccess = createAction(POST_UPLOAD_FILE_SUCCESS_BY_TASK_ID);
const postUploadFileByIDFailed = createAction(POST_UPLOAD_FILE_FAILED_BY_TASK_ID);


const taskAssignByTaskID = createAction(POST_ASSIGN_TASK_BY_TASKID);
const taskAssignByTaskIDSuccess = createAction(POST_ASSIGN_TASK_SUCCESS_BY_TASKID);
const taskAssignByTaskIDFailed = createAction(POST_ASSIGN_TASK_FAILED_BY_TASKID);

const availabilityCheckequest = createAction(GET_AVAILABILITY_CHECK);
const availabilityCheckRequestSuccess = createAction(GET_AVAILABILITY_CHECK_SUCCESS);
const availabilityCheckRequestFailed = createAction(GET_AVAILABILITY_CHECK_FAILED);

const coDetailsInsUpdDelRequest = createAction(CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST);
const coDetailsInsUpdDelRequestSuccess = createAction(CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_SUCCESS);
const coDetailsInsUpdDelRequestFailed = createAction(CO_PERSONAL_DETAILS_INS_UPD_DEL_REQUEST_FAILED);

const setActiveMenu = createAction(CURRENT_ACTIVE_MENU)

const getEntityLicenseTaskRequest = createAction(GET_ENTITY_LICENSE_TASK_REQUEST);
const getEntityLicenseTaskRequestSuccess = createAction(GET_ENTITY_LICENSE_TASK_REQUEST_SUCCESS);
const getEntityLicenseTaskRequestFailed = createAction(GET_ENTITY_LICENSE_TASK_REQUEST_FAILED);

const getCompanyTypeRequest = createAction(GET_COMPANY_TYPE_REQUEST);
const getCompanyTypeRequestSuccess = createAction(GET_COMPANY_TYPE_REQUEST_SUCCESS);
const getCompanyTypeRequestFailed = createAction(GET_COMPANY_TYPE_REQUEST_FAILED);

const insCertificateDetailsRequest = createAction(INS_CERTIFICATE_DETAILS_REQUEST);
const insCertificateDetailsRequestSuccess = createAction(INS_CERTIFICATE_DETAILS_REQUEST_SUCCESS);
const insCertificateDetailsRequestFailed = createAction(INS_CERTIFICATE_DETAILS_REQUEST_FAILED);

const getCoNotificationsRequest = createAction(GET_CO_NOTIFICATIONS_REQUEST);
const getCoNotificationsRequestSuccess = createAction(GET_CO_NOTIFICATIONS_REQUEST_SUCCESS);
const getCoNotificationsRequestFailed = createAction(GET_CO_NOTIFICATIONS_REQUEST_FAILED);
...
const getCoAccountLicensesRequest = createAction(GET_CO_ACCOUNT_LICENSES_REQUEST);
const getCoAccountLicensesRequestSuccess = createAction(GET_CO_ACCOUNT_LICENSES_REQUEST_SUCCESS);
const getCoAccountLicensesRequestFailed = createAction(GET_CO_ACCOUNT_LICENSES_REQUEST_FAILED);

const coAccountUpdateRequest = createAction(CO_ACCOUNT_UPDATE_REQUEST);
const coAccountUpdateRequestSuccess = createAction(CO_ACCOUNT_UPDATE_REQUEST_SUCCESS);
const coAccountUpdateRequestFailed = createAction(CO_ACCOUNT_UPDATE_REQUEST_FAILED);

const deleteCompanyRequest = createAction(CO_COMPANY_DELETE_REQUEST);
const deleteCompanyRequestSuccess = createAction(CO_COMPANY_DELETE_REQUEST_SUCCESS);
const deleteCompanyRequestFailed = createAction(CO_COMPANY_DELETE_REQUEST_FAILED);
