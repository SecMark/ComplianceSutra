...
function ChangePassword({ history }) {
  ...
  const onChangeHandler = (name) => (event) => {
    ...
    let passwordReg = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[\w~@#$%^&*+=`|{}:;!.?\"()\[\]-]{8,16}$/
    if (name === "password") {
      ...
      if (uppercaseandlowercaseRE.test(event.target.value)) {
        ...
        else if (/^[a-zA-Z]*$/.test(event.target.value) && /(?=.*?[A-Z])(?=.*?[a-z])./.test(event.target.value)) {
    ...
    console.log("errrorstate", passwordState)
    if (name === "newpassword") {
  ...
  const onSubmit = () => {
    ...
    email = location[1]
    setIsValidate(true);
    if ((errors.passwordErr !== "" || errors.newpasswordErr !== "") || (values.password === "" || values.newpassword === "")) {
      return;
    }
    setIsValidate(false);
    dispatch(
          ...
          <div className="container">
            <div className="">
              ...
              <div className="comtech_new_password newPass_form_wrapper">
                <p className="comtech_new_password_title">Reset your password</p>
                <div className="newPass_form_wrapper">
                  <div className="form-group">
                    ...
                    <input
                      type="password"
                      maxLength="16"
                      className={"form-control " + (values.password !== "" && " activeForm-control ") + (values.password !== "" && values.newpassword !== "" && values.password !== values.newpassword  && " input-error  "  ) 
                                  + ( errors && errors.passwordErr !== "" && " input-error ") + (isValidate &&  values.password === ""  && " input-error ")
                                  + (values.password !== "" && errors && errors.passwordErr == "" && " password-success-input ")
                                } 
                    ...
                    {/* {values.password === "" ||values.password === "" && errors && errors.passwordErr !== "" && <p className="input-error-message">
                      New password is required
                </p>} */}
                  {isValidate &&  values.password === "" && <p className="input-error-message">
                      New password is required
                </p>}
                  ...
                  <div className="form-group">
                    ...
                    <input
                      type="password"
                      maxLength="16"
                      className={"form-control " + (errors && errors.newpasswordErr !== "" && " input-error ")
                                  +(values.password !== values.newpassword && values.newpassword !== "" &&   " input-error ") + ( values.password == " " && " input-error" ) + (isValidate &&  values.newpassword === ""  && " input-error ")
                                  + (values.newpassword !== ""  &&  values.password == values.newpassword &&  " password-success-input activeForm-control")
                                }
                    ...
                    />
                    {/* {values.newpassword !== "" && errors && errors.newpasswordErr !== "" && <p className="input-error-message">
                      Confirm password is invalid
                </p>} */}

                    {isValidate &&  values.newpassword === "" && <p className="input-error-message">
              ...
              <div className="bottom-logo-strip">
                <div className="row aligncenter">
                  {/* <div className="col-md-6 col-xs-12">
                                <p className="account-link">Don't have an account?<span className="login-link"> SIGNUP</span></p>
                            </div> */}
