        ...
        apiServices.post("/api/getEmailbody", obj)
            .then(function (response) {
                ...
                if (
                    ...
                    toast.success("The reset password link has been sent to your email account successfully")
                } else {
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            className={"form-control" +
                                               (errors && values.email !== "" && errors.emailErr !== "" ? " input-error" : "")
                                                // (setErrors("") ? " jhd" : "non")
                                                // +  (setErrors(""))
                                                + (values.email !== "" && errors.emailErr === "" ? " success-form-control" : "")
                                            }
                                        ...
                                        />
                                        {errors && values.email !== ""&&  errors.emailErr !== "" && <p className="input-error-message">
                                            Email is invalid
                                     </p>}
                                    </div>
                            ...
                            <div className="bottom-logo-strip">
                                <div className="row aligncenter">
                                    <div className="col-md-6 col-xs-12 d-none d-sm-block">
                                        <p onClick={() => redirectToSignupScreen()} style={{ cursor: 'pointer' }} className="account-link">Don't have an account?<span className="login-link"> SIGNUP</span></p>
                                    </div>
