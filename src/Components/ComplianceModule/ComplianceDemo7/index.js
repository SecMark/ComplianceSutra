   ...
   return (
      <div className="compliance-end">
         ...
         <div className="back-ground-image">
            <div className="left-section">
               <div className="container">
                  ...
                  <div className="email-subscribe">
                     <p className="email-label">Want to share this with your manager or peers?</p>                   
                                 ...
                                 <div class="content">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <span class="input-group-btn">
                                          <button class="btn invite-btn" type="submit">INVITE</button>
                                       </span>                                
                              </div>
                           </div>
                        </div>                    
            ...
            <img  className="performance" src={Teamperformance} alt="Teamperformance" />
