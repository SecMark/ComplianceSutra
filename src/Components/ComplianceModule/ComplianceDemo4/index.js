...
function ComplianceDemo4() {
   ...
   const addOrRemoveTask = (value) => {
      ...
      tasks.map((item, key) => {
         if (key === index) {
            document.getElementById(value).classList.add("animate__animated", "animate__fadeOutLeft");
            setTimeout(() => {
            ...
            document.getElementById(item).classList.add("animate__animated", "animate__fadeInUp");
         }
      })
      if (index >= 0) {
               ...
               <div className="">
                  <div className="white-box-task-deatils">
                              ...
                              <div className="d-block d-sm-none">
                                 <div className="col-12 row pl-0 pr-0 margin-left-right">
                                    ...
                                    <div className="col-8 pr-0 pl-0">
                                       <p className="right-bold-text">{content && content[activeIndex] && content[activeIndex].title && content[activeIndex].title} </p>
                                    </div>
                                 ...
                                 <div className="col-12 row pl-0 pr-0 margin-left-right">
                                    ...
                                    <div className="col-8 pr-0 pl-0">
                                       <p className="right-bold-text">{content && content[activeIndex] && content[activeIndex].date && content[activeIndex].date}</p>
                                    </div>
                                 </div>
                                 <div className="col-12 row pl-0 pr-0 margin-left-right">
                                    <div className="col-4 pl-0 pr-0">
                     ...
                     <div className="right-white-grid  d-none d-sm-block">
                        ...
                        <div className="col-12 row pl-0 pr-0 margin-left-right">
                           <button disabled={activeTask === undefined} onClick={() => { setActiveIndex(task.indexOf(tasks[0]));addOrRemoveTask(tasks[0])}} className="mark-done-button">MARK AS DONE</button>
                        </div>
                     </div>
                  </div>
               </div>
