...
const stepperContentArray = [
   ...
   },
   {
      ...
      description: "Keep track of task completion and team performance both via dashboard and regular reports on mail & whatsapp"
   },
   {
      icon: TaskCompletionIcon,
      header: "Track completion & performance",
   ...
   },
   {
      ...
      description: "Guiding and handholding team such that focus is on executing the task on time"
   },
   {
      icon: AnticipateRisks,
      header: "Anticipate risks & be agile",
      description: "Anticipate risks and manage unexpected delays by taking corrective actions"
   },
]
...
function ComplianceMainModule({ history }) {
   ...
   const steps = [{ title: 'Drive completion with timeline' }, { title: 'Track completion & performance' }, { title: 'As easy as answering mall' }, { title: 'Anticipate risk & be agile' }, { title: 'Access & share compliance history' }];
         ...
         <p className="compliance compliance-mobile">Compliance Module Demo</p>
            <div className="row mobile-row-reverse">
               ...
               <img src={demoBg} alt="demoBg" />
                  ...
                  <div id="stepper" className="animate__animated animate__fadeInRight animate__delay-1s	5s stepper-section">
                     <Stepper
                        steps={steps}
