        ...
        <div className="fifth-section mt-5 mb-5">
            <div className="container">
                ...
                <div className="fifth-section-heading">
                    <h2 className="fifth-section-heading1">
                        Ready To get started?
                    </h2>
                    <h1 className="fifth-section-heading2">
                        Set up <span className="fifth-section-heading3">Compliance</span> for 
                    </h1>
                    <h1 className="fifth-section-heading2">
                        Your Company
                    </h1>
                ...
                <div className="d-flex justify-content-center">
                    <div className="p-2">
                         <button className="fifth-section-getstarted-button">Get Started</button>
                    </div>
                    <div className="p-2">
                ...
                <div className="container">
                <div className="fifth-section-linebreaker">
                </div>
                <div className="row">
                    <div className="col">
                        ...
                        <p className="fith-section-para">
                            We will be happy to ans your sales queries
                    ...
                    <div className="col">
                        ...
                        <p className="fith-section-para">
                        Suitable pricing options for companies with all sizes and requirements
                        </p>
                        <h3 className="fifth-section-contact-and-pricing">
