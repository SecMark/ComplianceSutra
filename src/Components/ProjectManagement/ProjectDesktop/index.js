...
const Project = () => {
  ...
  return (
    <>
      ...
      {/* Desktop Component */}
      <div className="d-none d-md-block project-management__project-item my-md-2 position-relative">
            ...
            <div className="project-management__project-item mb-md-2">
              ...
              {expandMoreLevel >= 2 && (
                <div className="py-2 pl-2 background--white">
                  <div className="position-relative project-management__project-item project-management__project-item-2 mb-md-2">
                    {isShowTaskContextMenu && (
                      <ProjectAndTaskContextMenu
                        containerRef={taskContextMenuRef}
                      />
                    )}
